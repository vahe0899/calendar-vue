/** Функция впринимает строку из окна быстрого добавления событий, 
делит на три объекта, определяет день и месяц и возвращает объект с этими данными
*@param "str" - строка вида "25 ноября, текст, текст"
*/
